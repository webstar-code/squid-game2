...
ReactDOM.createRoot(document.getElementById('root')!).render(
  <TonConnectUIProvider
    manifestUrl="https://firebasestorage.googleapis.com/v0/b/someappbot-6857c.appspot.com/o/manifest.json?alt=media&token=45086146-d32a-4be1-ac3d-f53c99bc300f"
